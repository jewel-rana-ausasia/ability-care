  ...
  return (
    <div>
      ...
      <div className="bg-white">
        {/* ===== Top Section ===== */}
        <div className="max-w-7xl mx-auto py-16 grid grid-cols-1 md:grid-cols-2 gap-2 items-center">
          {/* LEFT: Text */}
          <div>
          ...
          <div className="flex justify-center">
            <div className="relative w-full max-w-md aspect-video rounded-lg overflow-hidden">
              <Image
                src="/ndis-image.png" // ← replace with your actual image
                alt="NDIS Video"
                fill
