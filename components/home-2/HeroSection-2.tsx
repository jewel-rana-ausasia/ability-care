  ...
  return (
    <section className="relative w-full overflow-hidden flex items-center">
          ...
          <SwiperSlide key={index}>
            ...
            >
              ...
              <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-10 sm:py-14 md:py-20 grid lg:grid-cols-2 gap-8 items-center">
                <div className="text-gray-900 space-y-4 sm:space-y-6 z-10 text-center lg:text-left">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                    {slide.title}
                  </h1>

                  <p className="text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed opacity-90 max-w-xl mx-auto lg:mx-0">
                    {slide.description}
                  </p>
      ...
      <style jsx global>{`
        ...
        /* Ensure pagination spacing on small screens */
