...
const Navbar3: FC = () => {
  ...
  const getLinkClasses = (href: string) => {
    const baseClasses = "hover:text-[#A55FA4] transition-colors duration-200";
  ...
  return (
    <header className="w-full mx-auto">
      ...
      <nav className="bg-[#F6EFF6] shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-2 flex flex-wrap items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6 font-medium">
            ...
            >
              <button
                className={`flex items-center gap-1 font-semibold hover:text-[#A55FA4] transition ${
