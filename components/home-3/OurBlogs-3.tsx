...
export default function OurBlogSection3() {
  const posts = [
    ...
    },
    {
      ...
      desc: "Social activities are an essential part of life for everyone, regardless of ability. They can partic...",
    ...
    },
    {
      ...
      desc: "Occupational therapy (OT) plays a vital role in enhancing the quality of life for seniors. As people age...",
        ...
        {posts.map((post, i) => (
          ...
          >
            <Card className="overflow-hidden shadow-md bg-white border-0 hover:shadow-lg transition-shadow duration-300 p-0 rounded-3xl">
              ...
              <CardContent
                className="text-center px-6 mt-0 mb-8"
              >
                ...
                <Button
                  variant="link"
                  className="px-5 py-2 mt-4 text-white bg-[#6F3C72] rounded-full"
                >
                  Read More
                </Button>
              </CardContent>
