...
//   return (
//     <section className="w-full bg-[#F5EAF7] py-16 px-6 md:px-12 lg:px-20">
//       <div className="text-center md:text-left mb-6">
//         <span className="text-sm font-semibold tracking-wider text-purple-700 uppercase">
//           FAQ’s
//         </span>
...
export default function FAQSection() {
  ...
  return (
    <section className="w-full bg-[#F5EEF6] py-16 px-6 md:px-12 lg:px-20 flex flex-col items-center justify-center text-center">
